...
Please read carefully the meaning behind each of the heatmaps
"""
...
LAGGING_TIME_DESCRIPTION = """The term "Lagging time" refers to the duration it takes to from the moment *any* object is ready to perform the Activity,
